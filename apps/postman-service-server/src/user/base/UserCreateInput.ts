...
class UserCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => NotificationConfigCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => NotificationConfigCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => NotificationConfigCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => NotificationRequestCreateNestedManyWithoutUsersInput,
  })
  @ValidateNested()
  @Type(() => NotificationRequestCreateNestedManyWithoutUsersInput)
  @IsOptional()
  @Field(() => NotificationRequestCreateNestedManyWithoutUsersInput, {
    nullable: true,
  })
